...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		$this->document->addStyle('catalog/view/theme/f1/css/category.3ac54b5c2ab301c742a7.css');

		$this->document->addScript('catalog/view/theme/f1/js/341.50da31cc4fe2fd66ced6.js');
		$this->document->addScript('catalog/view/theme/f1/js/category.0f5dcdc7673b0df3501e.js');
		...
		if ($category_info) {
			...
			foreach ($results as $result) {
				...
				if ($result['special']) {
					$discount = 100 - $result['special'] / ($result['price'] / 100);
				} else {
					$discount = false;
				}
