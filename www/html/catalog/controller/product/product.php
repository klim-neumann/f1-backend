...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		$this->document->addScript('catalog/view/theme/f1/js/product.21b1b2066159ee722de0.js');
		...
		if ($product_info) {
			...
			if ($product_info['special']) {
				$data['discount'] = 100 - $product_info['special'] / ($product_info['price'] / 100);
			} else {
				$data['discount'] = false;
			}
			...
			$data['featured'] = $this->load->controller('extension/module/featured', $setting);
